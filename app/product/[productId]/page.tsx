...
export default async function ProductPage({ params }: { params: any }){
  ...
  return (
    <div className="flex flex-col md:max-w-2/3 md:mx-auto md:py-10 md:overflow-hidden md:rounded-2xl md:gap-5">
      <div className="flex flex-col md:flex-row">
        <div className="flex items-center justify-center w-full md:w-1/2 overflow-hidden md:rounded-l-2xl">
